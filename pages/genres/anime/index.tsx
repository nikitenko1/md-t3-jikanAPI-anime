...
const AnimeGenrePage = () => {
  //  https://api.jikan.moe/v4/genres/anime -->// {"data": [{...}]}
  const { data: animeGenres } = useSWR(`${API_ENDPOINT}genres/anime`, fetcher);
  ...
  return (
    <Container>
      <h1 className="py-4 text-xl font-bold">Anime Genres</h1>
      <input
        type="text"
